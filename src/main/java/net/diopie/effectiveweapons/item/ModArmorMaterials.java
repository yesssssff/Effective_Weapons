...
public enum ModArmorMaterials implements ArmorMaterial {
    SPIDER("spider", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.LEATHER, Items.FERMENTED_SPIDER_EYE});
    }),
