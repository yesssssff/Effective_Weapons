...
public class SpiderArmorItem extends ArmorItem implements IAnimatable {
    public SpiderArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.CAVE_SPIDER_BOOTS,
